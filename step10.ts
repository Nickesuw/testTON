...
async function main() {
  ...
  const mnemonic = "nasty tonight verb industry helmet clerk dumb thumb verb verb pass light lend lift pass federal rib verb light federal garbage depend helmet lend"; // your 24 secret words (replace ... with the rest of the words)
